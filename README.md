...
- 本项目关注的是，哪些码位字符在哪个地区属于日常可用或不应使用。像同一码位字符在不同地区所显示的字形的异同，某汉字部件从「王」或从「壬」这一类研究，皆【不】是本项目能够研究或关注的

- 对于“非寻常”字符的判断，主要以当今各地区使用状况为准（许多数据又是来自国际Unicode标准、网络项目如OpenCC），【并非】以考古或严谨的汉语汉字研究为准
...
- 淡蓝色：繁体
- 淡黄色：中文简体
  > 目前对一个字是简体还是合字，是繁体还是合字的判断，无法做到很准确
...
结合之前，修正一些来自UCD中的繁简多余数据（如果你认为这样修正有是错误的请开issue讨论）：
